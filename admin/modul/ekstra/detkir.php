...
<body>
	...
	<div class="row">
		<div class="col-md-4">
			...
			Total: <strong>Rp. <?php echo number_format($detail['totalharga']); ?></strong><br><br>
			
		</div>

		<div class="col-md-4">
			<h3>Status Kirim</h3>
			Status Pembelian:<br><font size="4"><strong><?php echo $detail['status']; ?></strong></font><br>
			Kurir:<br><font size="4"><strong><?php echo $detail['kurir']; ?></strong>
			</font><br>
			Resi Pengiriman:<br><font size="4"><strong><?php echo $detail['resi']; ?></strong>
			</font>
		</div>
